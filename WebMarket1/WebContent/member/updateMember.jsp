...
<%
	String sessionIdGet = (String) session.getAttribute("sessionId");
%>
	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="idPrint" type="text" class="form-control" placeholder="id"
						value="<c:out value='${row.id}'/>" disabled/>
